...
class HasMany extends AbstractRelationship
{
	...
	public function load_eagerly($models, $attributes=array(), $includes=array(), Table $table)
	{
...
class BelongsTo extends AbstractRelationship
{
	...
	public function load_eagerly($models, $attributes=array(), $includes, Table $table)
	{
